...
<script language="javascript" src="categories.js" type="text/javascript">
</script>

<br>

If you would like to request an article be written on the English Wikipedia, please fill out the information below.  Fields with a <font color="red">*</font> are required.
<br>
<br>
<noscript>
	<style type="text/css">
...
<tr>
<td colspan="2">
<input type="checkbox" name="doublecheck" onchange="checkbox()"> <font color="red">*</font> I affirm that the article I'm submitting for creation follows all of Wikipedia's guidelines.<br>I've checked <a href="<?=$wpHref ?>Wikipedia:Requested_articles" target=_blank>the request list</a> and I'm not submitting a duplicate.
</td>
</tr>
<tr>
<td>
